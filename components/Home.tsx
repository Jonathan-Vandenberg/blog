...
export default function App({ posts }: any) {
  return (
    <section>
      <div className="container max-w-6xl underline-offset-2 underline mx-auto text-2xl p-6 text-gray-700">
        Featured Post
      </div>
      <div className="container max-w-6xl px-6 mx-auto space-y-6 sm:space-y-12">
        <FeaturedPost post={posts[1].node} />
        <div className="">
          <div className="underline text-2xl text-gray-700 mb-6">All Posts</div>
